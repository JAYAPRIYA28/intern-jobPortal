...
const handleSubmit = async (event) => {
   ...
   <div className=" containerStyle max-width: 768px">
    ...
    <div>
         ...
         <input className="ml-20 box" name="language_known" value={info.language_known} placeholder={studentdetails.language_known}  onChange={handleOne} ></input><br/>
